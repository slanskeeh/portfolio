...
export function ProjectAnalytics() {
  ...
  return (
    <article className="min-w-0 overflow-hidden rounded-[var(--radius-panel)] border border-white/8">
      <div className="grid min-w-0 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
        <div className="min-w-0 bg-cobalt p-5 text-fog md:p-8">
        ...
        <div className="grid min-w-0 gap-px bg-white/8 sm:grid-cols-2">
          ...
          <div className="min-w-0 bg-ink p-5">
            ...
            <RadialChart
              value={72}
              label="retention"
              className="mx-auto mt-2 h-[120px] w-[120px] max-w-full sm:h-[140px] sm:w-[140px]"
            />
          </div>
        </div>
      </div>
