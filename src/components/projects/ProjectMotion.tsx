...
export function ProjectMotion() {
  ...
  return (
    <article className="overflow-hidden rounded-[var(--radius-panel)] bg-ink-2">
      <div className="grid items-stretch lg:grid-cols-2">
        ...
        <div className="relative min-h-[260px] bg-ink p-5 md:p-8">
          <p className="font-mono text-[11px] text-mist">Наведитесь на карточку </p>
          <div className="group relative mx-auto mt-8 h-[180px] max-w-[320px]">
